...
import { Event } from '@/app/archiwum/data/events';
import { calculateEndHour, canRegister, isEventInPast } from '@/app/archiwum/utils/events';
...
const EventBox: FC<EventBox> = ({
  ...
  `}>
      ...
      <div className="flex md:flex-col items-start gap-1">
        {canRegister(eventDate) && registrationUrl && (
          <a href={registrationUrl} rel="nofollow noreferrer noopener" target="_blank">
            <div className="flex gap-2 text-sm items-center text-gray-dark hover:text-secondary transition-all whitespace-nowrap">
    ...
    <div className="shadow-2xl flex flex-col md:flex-row w-full">
      <div className="w-full md:w-[200px] overflow-hidden md:rounded-l-lg min-w-[200px]">
        {
          image && (
            <Image
              src={image}
      ...
      ">
        ...
        <div className="flex flex-col md:flex-row">
          <div className="flex md:mr-6 text-sm items-center text-gray gap-2">
            <svg xmlns="http://www.w3.org/2000/svg" fill="none" viewBox="0 0 24 24" strokeWidth={1.5} stroke="currentColor" className="w-6 h-6">
