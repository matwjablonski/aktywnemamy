...
export const events: Event[] = [
  ...
  {
    id: 'czytam-kwiecien-2024',
    title: 'Aktywne czytanie niemowlętom i starszakom. Warsztat czytelniczy',
    description: 'Warsztat jest przeznaczony dla rodziców, którzy chcą już od pierwszych dni życia pokazywać i czytać dzieciom wartościowe książki, wspierając ich rozwój mowy, zdolności poznawcze i społeczne czy umiejętność koncentracji. W czasie zajęć zastanowimy się nad tym, jakie książki dostępne obecnie na rynku nadają się do aktywnego czytania, które jest innowacyjną metodą spędzania wolnego czasu z dziećmi, wpływającą pozytywnie na rozwój intelektualny. Uczestnicy poznają między innymi przykładowe książki dźwiękowe, z ruchomymi elementami, z dziurkami, dotykowe, przeplatanki, pop up, encyklopedie obrazkowe czy picture booki. Będą mogli także wymienić się własnymi inspiracjami lekturowymi oraz sposobami na rozbudzenie miłości do książek wśród dzieci. Podyskutujemy o tym, jak dbać o kulturę czytelniczą w domu i poza domem, by czytanie stało się dla najmłodszych nawykiem, czynnością naturalną i sprawiającą przyjemność. Porozmawiamy o popularnej dzisiaj metodzie nauki czytania – o czytaniu globalnym. Na koniec poczytamy dzieciom i wykonamy z nimi kilka zabaw paluszkowych. Mile widziana jest więc obecność niemowląt i starszaków na tym warsztacie.',
    eventDate: new Date('Wed, 03 Apr 2024 8:00:00 GMT'),
    duration: 1.5,
    trainer: 'Jolanta Nawrot-Sprysak',
    place: 'Świetlica w Dąbrowie',
  ...
  },
  {
    ...
    title: 'Angielski z Julią. Warsztat 1/3',
    description: 'Here and now - powtórka z czasów teraźniejszych, podawanie informacji o sobie, rozmowa o zaintersowaniach, small talk. 1. Czas present simple i present continuous, zastosowanie, konstrukcja, ćwiczenia. 2. Podstawowe słownictwo z zakresu danych osobowych i sytuacji rodzinnej, nawiązywanie konwersacji, opowiadanie o sobie, jak prowadzić small talk. 3. Konwersacje w grupie i w parach z użyciem kart pracy.',
    eventDate: new Date('Fri, 05 Apr 2024 16:00:00 GMT'),
    duration: 1.5,
  ...
  },
  {
    ...
    title: 'Trening funcjonalny "Aktywna Mama" Aneta',
    description: 'Trening Aktywna Mama. Zajęcia te to trening medyczny dla MAM po okresie połogu w towarzystwie dzieci do 1.roku życia. Ten trening to przestrzeń na: ✅ odbudowę funkcji ciała po ciąży i porodzie, poprawę świadomości ciała, kontroli ruchu (stabilizacji) i koordynacji nerwowo-mięśniową oraz postawę ciała, ✅ przygotowanie organizmu do powrotu do sportu, ✅ okazję do spędzenia czasu z dzieckiem i zacieśnienia więzi emocjonalnej, ✅ budowanie relacji społecznej i zwiększenie poczucia wspólnoty z innymi mamami, ✅ pierwsze interakcje dzieci z rówieśnikami',
    eventDate: new Date('Wed, 10 Apr 2024 08:50:00 GMT'),
    duration: 0.8333,
    trainer: 'Aneta Biadun',
    place: 'Świetlica w Dąbrowie',
    image: '/events/aktywna-mama-cwiczenia.jpg',
  ...
  },
  {
    ...
    title: 'Polski język migowy - jak go wykorzystać w komunikacji z niemowlętami',
    description: 'Nasze dzieci chcą nam komunikować dużo wcześniej niż pozwala im na to aparat artykulacyjny. Gesty są dla nich sposobem porozumiewania się, dlatego na warsztatach nauczymy się podstawowych zwrotów z polskiego języka migowego, które będziemy mogły wykorzystać w codziennych sytuacjach. Na warsztacie Prelegentka opowie o bobomigach, nauczy podstawowych znaków i 1-2 wierszyków.',
    eventDate: new Date('Wed, 17 Apr 2024 08:00:00 GMT'),
    duration: 1.5,
    trainer: 'Marta Kłosińska',
    place: 'Świetlica w Dąbrowie',
  ...
  },
  {
    ...
    title: 'Angielski z Julią. Warsztat 3/3',
    description: 'In the future – wyrażanie przyszłości w języku angielskim, opowiadanie o planach i zamiarach. 1. Czas future simple, present continuous i wyrażenie to be going to do opowiadania o przyszłych wydarzeniach, zastosowanie, konstrukcja, ćwiaczenia. 2. Konstruowanie wypowiedzi o przyszłości, prowadzenie rozmowy o planach i zamierzeniach, podejmowanie spontanicznych decyzji. 3. Ja za 10 lat, jak siebie widzę, swobodna wypowiedź. :-)',
    eventDate: new Date('Fri, 19 Apr 2024 16:00:00 GMT'),
    duration: 1.5,
    trainer: 'Julia Śmidowicz',
    place: 'Świetlica w Dąbrowie',
    image: '/events/angielski.jpg',
  ...
  },
  {
    ...
    title: 'Życie po porodzie - warsztat z Fizjobroszka',
    description: 'mgr Martyna Stanisławska: Certyfikowana fizjoterapeutka uroginekologiczna PTUG. Absolwentka Akademii Wychowania Fizycznego w Poznaniu na kierunku fizjoterapia. Na Instagramie znana jako „Fizjobroszka”. Pracuje w zawodzie od 2014 roku. Swoją karierę zawodową rozpoczęła pracując w Ortopedyczno-Rehabilitacyjny Szpitalu Klinicznym im. W. Degi w Poznaniu, a później przez kolejne 8 lat w poznańskiej klinice Rehasport. Początkowo skupiona na fizjoterapii ortopedycznej, a od 5 lat specjalizuje się i pogłębia pasję w pracy z kobietami w obszarze zdrowia intymnego i fizjoterapii uroginekologicznej. Stale podnosi swoje kompetencje uczestnicząc w różnych szkoleniach. Prowadzi warsztaty przygotowujące do porodu we współpracy z trzema szkołami rodzenia. Na co dzień prowadzi gabinet w podpoznańskim Przeźmierowie. Prywatnie mama Krysi i Jadzi.',
    eventDate: new Date('Wed, 24 Apr 2024 08:30:00 GMT'),
    duration: 1,
  ...
  },
  {
    ...
    place: 'Świetlica w Dąbrowie',
    image: '/events/makrama.jpg',
    registrationUrl: 'https://forms.gle/YhUwwJCmLGDSSCyL7',
    detailsUrl: '',
  },
  {
    id: 'maj-2024-2',
    title: 'Samoobrona kobiet - zaufaj wojsku',
    description: 'Ministerstwo Obrony Narodowej wraz z Centrum Szkolenia Wojsk Lądowych w Poznaniu zaprasza na szkolenie z samoobrony organizowane dla mam z gminy Dopiewo. Żołnierze - instruktorzy nauczą podstawowych zasad codziennego bezpieczeństwa, sposobów wykrywania oraz unikania zagrożeń. Pokażą techniki walki wręcz przydatne w niebezpiecznych sytuacjach. Uczestniczki będą miały także okazję zapoznać się z zasadami zdrowego stylu życia oraz odświeżyć praktyczną wiedzę nt. zasad udzielania pierwszej pomocy. UWAGA! W szkoleniu nie mogą brać udziału kobiety w ciąży i świeżo po trudnych zabiegach medycznych. Obowiązuje strój sportowy, tj. dres, t-shirt, obuwie sportowe. Prosimy o zabranie ze sobą wody.',
    eventDate: new Date('Sat, 11 May 2024 07:00:00 GMT'),
    duration: 4,
    trainer: 'MON i Centrum Szkolenia Wojsk Lądowych w Poznaniu',
    place: 'Świetlica w Dąbrowie',
    image: '/events/samoobrona.jpg',
    registrationUrl: 'https://forms.gle/3d1fA5ND91azUC99A',
    detailsUrl: '',
  },
  {
    id: 'maj-2024-3',
    title: 'Trening funcjonalny "Aktywna Mama"',
    description: 'Prowadzone zajęcia pozwolą na odbudowę funkcji po ciąży i porodzie, poprawę świadomości ciała, kontroli ruchu (stabilizacji), koordynacji nerwowo-mięśniowej oraz postawy ciała. Przygotowują młode mamy do powrotu do sportu. Jest to świetna okazja na spędzenie czasu z dzieckiem, budowanie relacji społecznych oraz pierwsze interakcje maluszków z rówieśnikami.',
    eventDate: new Date('Wed, 15 May 2024 08:50:00 GMT'),
    duration: 0.833,
    trainer: 'Aneta Biadun',
    place: 'Świetlica w Dąbrowie',
    image: '/events/aktywna-mama-cwiczenia.jpg',
    registrationUrl: 'https://forms.gle/vXahYzP4phxEmvK96',
    detailsUrl: '',
  },
  {
    id: 'maj-2024-4',
    title: 'Ono rusza w świat - jak to przeżyć?',
    description: 'Warsztat z psychologiem o emocjach, które budzą się w nas, gdy przychodzi czas rozstań z naszymi dziećmi. mgr Martyną Miziniak-Kużaj - psycholog, Psychoterapeuta w trakcie certyfikacji, Terapeuta, Doradca seksuologiczny, Trener interpersonalny. Pracuje w ramach systemowego podejścia psychoterapeutycznego. Towarzyszy Państwa staraniom w dokonaniu i wprowadzeniu zmian w życie. Do każdego podchodzę w sposób indywidualny, wysłuchuję Państwa opowieści i zadaję pytania, które te opowieści uzupełniają i doprowadzając do szerszej perspektywy i kontekstu.',
  ...
  },
  {
    ...
    trainer: 'Aneta Biadun',
    place: 'Świetlica w Dąbrowie',
    image: '/events/shape.jpg',
    registrationUrl: 'https://forms.gle/QhytrJZS3oTvueo99',
    detailsUrl: '',
  },
  {
    id: 'maj-2024-6',
    title: 'Spotkanie przy kawie na Dzień Mamy',
    description: 'Zapraszamy Was na wyjątkowe spotkanie, które odbędzie się w ramach inicjatywy "Aktywna Mama", dedykowanej wszystkim mamom. Chcemy, aby to wydarzenie nie tylko integrowało nas, ale także umożliwiło dzielenie się naszymi talentami i pasjami. Dlatego też serdecznie zachęcamy do podzielenia się waszymi umiejętnościami cukierniczymi z nami ;) Jeśli macie ochotę i czas, przygotujcie swoje ulubione ciasto, które umili nam wspólny czas. Inicjatywa "Aktywna Mama" powstała z myślą o Was i została zainicjowana przez nas. Wiemy, że macie wiele do zaoferowania - nie tylko jako opiekunki, ale również jako kobiety pełne pasji i talentów. Dlatego też zachęcamy Was, drogie Mamy, abyście mogły podzielić się czymś od siebie, byśmy wszyscy mogli skorzystać. Spotkanie to nie tylko okazja do rozmów, ale także do budowania wspólnoty, dzielenia się doświadczeniami i wzajemnego wsparcia. Razem możemy stworzyć miejsce, gdzie każda Mama poczuje się doceniona i zrozumiana.',
    eventDate: new Date('Sat, 25 May 2024 09:30:00 GMT'),
    duration: 2,
    trainer: 'Aktywne Mamy',
    place: 'Świetlica w Dąbrowie',
    image: '/events/coffee.jpg',
    registrationUrl: 'https://forms.gle/zX3FHY4Dp7XpdMu66',
    detailsUrl: '',
  },
];
